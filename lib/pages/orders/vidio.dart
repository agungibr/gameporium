...
class Vidio extends StatefulWidget {
  String name;
  String image;
  Vidio({super.key, required this.name, required this.image});

  @override
  State<Vidio> createState() => VidioState();
}

class VidioState extends State<Vidio> {
  final List _vidioList = DataList.vidioList;
