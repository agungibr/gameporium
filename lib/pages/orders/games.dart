...
class Games extends StatefulWidget {
  String name;
  String image;
  Games({super.key, required this.name, required this.image});
...
class _GamesState extends State<Games> {
  final List _ffDiamondsList = DataList.ffDiamondsList;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GridView.builder(
                            ...
                            itemCount: _ffDiamondsList.length,
